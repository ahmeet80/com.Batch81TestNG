...
public class P01 extends TestBaseBeforeClassAfterClass {
    ...
    driver.get("https://www.techlistic.com/p/selenium-practice-form.html");
        ...
        //fill the lastname
        driver.findElement(By.xpath("//input[@name='lastname']")).sendKeys("Arslan");
        ...
        //driver.findElement(By.xpath("//select[@id='continents']")).sendKeys("Antartica"); // Bu da calışır ama tavsiye edilmez
        //choose your command  -> Browser Commands
